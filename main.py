...
pygame.display.set_caption('Flappy Bird by Shadow')
...
restart_button = Button(screen_width // 2 - 50, screen_height // 2 - 100, button_img)
...
while run:
    ...
    screen.blit(ground_img,(ground_scroll ,676))
    screen.blit(ground_img, (ground_scroll + 864, 676))
    ...
    # Check is bird hit the ground
    if flappy.rect.bottom > 676:
        game_over = True
        flying = False
